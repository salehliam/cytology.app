...
<script>  
  ...
  $(document).ready(function(){                        
    ...
    initTable('/ds/examsByContractor/{{$contractor_id}}',getColumns());
    setTitleBar('/conname/{{$contractor_id}}');
    customFilterInit();
 ...
 <img src="images/contractor.png" style="float: left;"/><div class="titleBar"></div><div class="closeButton btn btn-default">zamknij</div>
  </div>
